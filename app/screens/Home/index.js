                    ...
                    >
                        <View style={{ alignItems: "center" }}>
                            ...
                            >
                                ...
                                {/* <View style={!isRTL ? styles.contentServiceIcon : styles.contentServiceIconRTL}>
                            ...
                            <FlatList
                                ...
                                renderItem={({ item, index }) => (
                                    ...
                                    >
                                        ...
                                        <View
                                            style={!isRTL ? styles.contentCartPromotion : styles.contentCartPromotionRTL}
                                        >
                                            <Button
                        ...
                        {/* <View>
                            <View style={styles.contentHiking}>
                                <Text title3 semibold
                                    style={!isRTL ? {marginLeft: 20, textAlign: 'left'} : { marginRight: 20, textAlign: 'right'}}
                                >
                                    Tours
                                </Text>
